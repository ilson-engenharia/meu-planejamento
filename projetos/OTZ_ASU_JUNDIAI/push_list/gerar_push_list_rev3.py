...
EXCEL_IN = os.path.join(UPLOAD, "77d7fd63-BANCO_DE_DADOS_DAENG_PUSH_LIST_ASU_JUNDIAI_11072026_REV04.xlsx")
...
# Data de referência: REV04 Lucas 11/07/2026
...
WORKING_DAYS = [
    ...
    date(2026, 7, 11),  # Sáb  — dia 7  ← TODAY
