...
EXCEL_IN = os.path.join(UPLOAD, "e9671819-BANCO_DE_DADOS_DAENG_PUSH_LIST_ASU_JUNDIAI_10072026_REV03.xlsx")
...
# Data de referência: REV03 Lucas 10/07/2026
...
WORKING_DAYS = [
    ...
    date(2026, 7, 10),  # Sex  — dia 6  ← TODAY
